...
class PseudoBasis:
    ...
    def express_as_Q_module(self, do_lll = True):
        ...
        assert self.det() == det(M), f"Descend to Q failed!" + str(self.det().n(_sage_const_29 ) )+ ' vs ' + str(det(M).n(_sage_const_29 ))
